package com.firefly.data.business.intelligence.infra.mappers;

import com.firefly.data.business.intelligence.infra.dtos.orbis.OrbisCriteria;
import com.firefly.data.business.intelligence.infra.dtos.orbis.OrbisMatchRequest;
...
public interface OrbisMapper {
    ...
    default List<String> getSelectFields() {
        return List.of(
                "Match.Hint", "Match.Score", "Match.Name", "Match.Name_Local",
                "Match.MatchedName", "Match.MatchedName_Type", "Match.Address",
                "Match.Postcode", "Match.City", "Match.Country", "Match.Address_Type",
                "Match.PhoneOrFax", "Match.EmailOrWebsite", "Match.National_Id",
                "Match.NationalIdLabel", "Match.State", "Match.Region", "Match.LegalForm",
                "Match.ConsolidationCode", "Match.Status", "Match.Ticker",
                "Match.CustomRule", "Match.Isin", "Match.BvDId"
        );
    }
}
